...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="h4 text-secondary mb-0">Registrar Nuevo Empleado</h2>
        ...
        <form action="{{ url('/empleados') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="level_id" class="form-select" required>
                        ...
                        @foreach($niveles as $nivel)
                            <option value="{{ $nivel->id }}" {{ old('level_id') == $nivel->id ? 'selected' : '' }}>{{ $nivel->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <select name="support_category" class="form-select">
                        ...
                        <option value="Administración" {{ old('support_category') == 'Administración' ? 'selected' : '' }}>Administración</option>
                        <option value="Apoyo" {{ old('support_category') == 'Apoyo' ? 'selected' : '' }}>Apoyo</option>
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="ihss_number" class="form-control" value="{{ old('ihss_number') }}">
                </div>
                <div class="col-md-3">
            ...
            <div class="mt-4 text-end">
                <button type="submit" class="btn btn-theme px-4 fw-bold"><i class="fa fa-save mt-1"></i> Guardar Empleado</button>
            </div>
        </form>
    </div>
</div>
