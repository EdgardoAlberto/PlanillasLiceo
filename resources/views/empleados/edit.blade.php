        ...
        <div class="card-body p-4">
            ...
            <form action="{{ url('/empleados/' . $empleado->id) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="employee_code" class="form-control"
                            value="{{ old('employee_code', $empleado->employee_code) }}" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="first_name" class="form-control"
                            value="{{ old('first_name', $empleado->first_name) }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Apellidos *</label>
                        <input type="text" name="last_name" class="form-control"
                            value="{{ old('last_name', $empleado->last_name) }}" required>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" name="base_salary" class="form-control"
                            value="{{ old('base_salary', $empleado->base_salary) }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Fecha de Ingreso</label>
                        <input type="date" name="hire_date" class="form-control"
                            value="{{ old('hire_date', $empleado->hire_date) }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Estado *</label>
                        <select name="status" class="form-select" required>
                            <option value="Activo" {{ old('status', $empleado->status) == 'Activo' ? 'selected' : '' }}>Activo
                            </option>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="bank_name" class="form-control"
                            value="{{ old('bank_name', $empleado->bank_name) }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Cuenta Bancaria *</label>
                        <input type="text" name="bank_account" class="form-control"
                            value="{{ old('bank_account', $empleado->bank_account) }}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Número IHSS</label>
                        <input type="text" name="ihss_number" class="form-control"
                            value="{{ old('ihss_number', $empleado->ihss_number) }}">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="mt-4 text-end">
                    <button type="submit" class="btn btn-theme px-4 fw-bold"><i class="fa fa-save mt-1"></i> Actualizar
                        Empleado</button>
                </div>
            </form>
        </div>
